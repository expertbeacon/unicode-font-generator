    ...
    return (
      <div className="mb-5 pb-4 border-b leading-7 flex flex-col lg:flex-row lg:items-center justify-start gap-5">
        ...
        <div className="relative flex flex-col lg:flex-row lg:justify-between w-full lg:items-center gap-3">
          <div className="text-2xl md:text-3xl font-bold p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg border-2 border-blue-200 dark:border-blue-800 shadow-lg">
            {transformedContent}
          </div>
